...
/* Va a la ready list, busca un proceso para hacerle un cambio
   de lugar para volver a ejecutar */
void
thread_yield (void) 
{
...
schedule (void) 
{
  ...
  // Verifica que sea un thread checando la variable magic,si hubo un stack over flow no es un thread.
